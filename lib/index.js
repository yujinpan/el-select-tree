...
var script = {
  ...
  methods: {
    ...
    setTreeDataState: function setTreeDataState() {
      ...
      treeEach(this.data, function (node) {
        node.disabled = disabledValues.includes(node[_this2.propsValue]);
      });
    },
  ...
  mounted: function mounted() {
    ...
    this.setSelected();
    this.$nextTick(function () {
      var popper = _this4.$refs.elPopover.$refs.popper;
      var width;

      if (!_this4.popoverMinWidth) {
        var clientWidth = _this4.$el.clientWidth;
