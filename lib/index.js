...
var script = {
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      ...
      if (clientWidth) {
        _this2.popoverWidth = clientWidth;
      }
    });
  }
};
